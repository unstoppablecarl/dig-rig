import { MatterType, OIL, SALT_WATER, SETTLED_FLAG, WATER } from '../_Matter-types.ts'
...
const def: ElementDef = {
  ...
  action(world, tx, ty, idx, next): void {
    ...
    if (world.hasDensityBelow(tx, ty, WATER) || world.hasDensityBelow(tx, ty, OIL)) { next.add(idx); return }
